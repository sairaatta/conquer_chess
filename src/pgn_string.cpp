...
pgn_string::pgn_string(const std::string& pgn_str)
  : m_pgn_str{pgn_str}
{
...
{
  return pgn_string("1. e4 e6 2. d4 b6 3. a3 Bb7 4. Nc3 Nh6 5. Bxh6 gxh6 6. Be2 Qg5 7. Bg4 h5 8. Nf3 Qg6 9. Nh4 Qg5 10. Bxh5 Qxh4 11. Qf3 Kd8 12. Qxf7 Nc6 13. Qe8# 1-0");
}

pgn_string get_scholars_mate_as_pgn_str() noexcept
{
  return pgn_string("1. e4 e5 2. Qh5 Nc6 3. Bc4 Nf6?? Qxf7# 1-0");
}
...
void test_pgn_string()
{
  ...
  // split_pgn_str
  {
    assert(split_pgn_str(pgn_string("1. e4 e5")).size() == 2);
  }
  #endif
}
